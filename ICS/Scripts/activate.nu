...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Programming\Python\CS_301\Internet Cafe System\ICS'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Programming\Python\CS_301\Internet Cafe System\ICS\Scripts\deactivate.nu'
